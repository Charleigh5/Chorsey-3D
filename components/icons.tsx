...
export const CoinIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25ZM9 7.5a.75.75 0 0 0 0 1.5h1.755a2.25 2.25 0 0 1 1.68 3.841 3.001 3.001 0 0 1-2.836.353.75.75 0 0 0-.71.133l-1.09 1.09a.75.75 0 0 0 1.06 1.06l1.09-1.09a4.501 4.501 0 0 0 4.252-5.332A3.75 3.75 0 0 0 12.75 9H15a.75.75 0 0 0 0-1.5H9Z"
      clipRule="evenodd"
    />
  </svg>
);
